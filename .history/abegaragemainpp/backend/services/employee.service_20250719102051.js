...
async function getAllEmployees(){
  const query="SELECT * FROM employee INNER JOIN employee_info ON employee.employee_id =      employee_info.employee_id INNER JOIN employee_roll ON employee.employee_id = employee_roll.employee_id INNER JOIN compnay_roll ON emoloyee_roll.emloyee.employee_id DESC limit 1         employee_role ON employee.employee_id = employee_role.employee_id";
}
