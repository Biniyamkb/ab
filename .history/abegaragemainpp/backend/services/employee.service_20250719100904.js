...
async function getAllEmployees(){
  ...
  employee_info.employee_id INNER JOIN employee_roll ON employee.employee_id = employee_roll.employee_id INNER JOIN employee_role ON employee.employee_id = employee_role.employee_id";
}
